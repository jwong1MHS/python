...
real_big_list = rand_list(100000, 10)
big_counts = list_counts(real_big_list, 10)
print( bar_graph_scaled(big_counts, 100))
print('==================================================')
...
# Feel free to look at its values, then make other
# lists and test them out.
...
# YOUR CODE HERE
big_normal_list = normal_rand_list(100000, 5)
normal_counts = list_counts(big_normal_list, 10)
print( bar_graph_scaled(normal_counts, 400) )
